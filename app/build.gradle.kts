...
android {
    namespace = "com.example.backgroundmusicplayer"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.backgroundmusicplayer"
        minSdk = 26  // API 26 (Android 8.0) for notification channels and modern APIs
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
